...
n_simuls = 100;
db_location = "results/simulation_results_exp23_32hz_revision.db";
    ...
    for ifilter = 4
        ...
        for imethod = 1:height(comb)
            for iwindow = 1:length(window_options)
                ...
                run_simulation(n_simuls, sliced_trials{itask, ifilter}, time_vec, method_table, db_location)
