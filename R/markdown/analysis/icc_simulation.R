...
if(compute_new == TRUE){
  ...
  for (i in seq_along(data_list)){
    ...
    conn = dbConnect(SQLite(), paste0("../scripts/results//simulation_results_exp23_", possible_filters[i], "_revision.db"))
    ...
    liesefeld_conn = dbConnect(SQLite(), paste0("../scripts/results//simulation_results_exp23_", possible_filters[i], "_revision_liesefeld.db"))
  ...
  save(average_data, file = "./markdown/analysis/processed_data/average_data_simulation_revision.Rdata")
} else {
  load(file = "./markdown/analysis/processed_data/mean_missing_by_method_simulation_revision.Rdata")
  load(file = "./markdown/analysis/processed_data/average_data_simulation_revision.Rdata")
}
